(function() {
    var AppRouter = Backbone.Router.extend({
        ...
        deps : {
               ...
               mySubordinateDetail:["assets/services/partnerDetail.js", "assets/models/partnerDetail.js", "assets/views/mySubordinateDetail.js"],
               ...
               myStaffPersonalDetail:["assets/services/partnerDetail.js", "assets/models/partnerDetail.js", "assets/views/myStaffPersonalDetail.js"],
    ...
    Backbone.history.start();
     if (routerType ==="enterprise") {
        appRouter.navigate("enterprise", {
            trigger : true
        });
    }else if(routerType ==="mySubordinate"){
         appRouter.navigate("mySubordinate", {
            trigger : true
        });
    }else if(routerType ==="partnerAll"){
