var clueDetailTemplate = loadTemplate('assets/templates/staff/allotedClueDetail.html');

var allotedClueDetailView = Backbone.View.extend({
	initialize:function(){},
	el:'#alloted',
...
var allotedClueDetailViewObj = new allotedClueDetailView();