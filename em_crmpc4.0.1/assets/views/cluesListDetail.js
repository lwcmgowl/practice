//加载并初始化模板对象
var cluesListdetailTemplate = loadTemplate("assets/templates/staff/cluesListDetail.html");
//列表容器VIEW
var cluesListdetailView = Backbone.View.extend({  
    initialize : function() {
    ...
    model : new cluesListDetailModel(),
    template : cluesListdetailTemplate,
...
var clueListdetailInstance = new cluesListdetailView();
