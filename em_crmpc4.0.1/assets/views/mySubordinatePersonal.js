//加载并初始化模板对象
var marketTemplate = loadTemplate("assets/templates/staff/mySubordinatePersonal.html");
var mySubordinatePersonal=loadTemplate("assets/templates/staff/myStaffPersonalDetail.html");
//列表容器VIEW
var marketListView = Backbone.View.extend({
    ...
    initinfo : function() {
        ...
        $("#detailpartdiv").html(mySubordinatePersonal);
        ...
        new DataTable({
            ...
            columnDefs : [{
                ...
                render : function(i, j, c) {
                     var html = "<a href='javascript:;' onclick='individualViewInstance.myStaffPersonalDetail(\"" + c.id + "\")' title="+c.contactName+">" + c.contactName + "</a>";
                      return html;
                }
            }],
         ...
         self.model.fetch({
            success : function(cols, resp, options) {
                ...
                for (var p in piclist) {
                  ...
                  $('#mystaffPer .editable').editable('disable');
            },
