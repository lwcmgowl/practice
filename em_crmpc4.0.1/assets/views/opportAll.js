//加载并初始化模板对象
var marketTemplate = loadTemplate("assets/templates/staff/opportDetail.html");
       ...
       'click #searchbtn' : function() {
        ...
        'click #exportFile' : 'exportFile',
         ...
         "click #businessInfo":function(){
            this.opportAllDetailList(this.model.get("id"));
        },
                ...
                render : function(i, j, c) {
                   var maxwidth=8;
                        if(c.opptTtl.length>maxwidth){
                             var html = "<a href='javascript:;' onclick='marketListViewInstance.opportAllDetail(\"" + c.id + "\")' title=" + c.opptTtl + ">" + c.opptTtl.substring(0,maxwidth)+"..." + "</a>";
                              return html;
                        }else{
                             var html = "<a href='javascript:;' onclick='marketListViewInstance.opportAllDetail(\"" + c.id + "\")' title=" + c.opptTtl + ">" + c.opptTtl + "</a>";
                             return html;
                        };
                }
            },{
