//加载并初始化模板对象
var marketTemplate = loadTemplate("assets/templates/staff/partnerAll.html");
var partnerAll=loadTemplate("assets/templates/staff/partnerAllDetail.html")
//列表容器VIEW
var parterAllListView = Backbone.View.extend({
    initialize : function() {
        this.stickit();
    },
    el : '#contentdiv',
    ...
    initinfo : function() {
        $('#partnerAllPersonal').empty();
        var self = this;
        self.render();
        handlerTop('btnWrapper');
        $("#detailpartdiv").html(partnerAll);
        ...
        new DataTable({
            ...
            columnDefs : [{
                ...
                render : function(i, j, c) {
                    var html = "<a href='javascript:;' onclick='enterpriseViewInstance.partnerAllDetail(\"" + c.id + "\")' title="+c.companyName+">" + c.companyName + "</a>";
                    return html;
                }
            }],
        ...
        var pushRight = document.getElementById( 'pushRight' );
          ...
          self.model.fetch({
            success : function(cols, resp, options) {
               ...
               $('#partnerAllDetail .editable').editable('disable');
            },
...
var enterpriseViewInstance = new parterAllListView();
