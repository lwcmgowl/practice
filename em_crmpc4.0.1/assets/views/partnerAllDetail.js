//加载并初始化模板对象
var partnerTemplate = loadTemplate("assets/templates/staff/partnerAllDetail.html");
var picurllist = "";
var partnerId='';
//列表容器VIEW
var partnerAllDetailView = Backbone.View.extend({
    initialize : function() {
        this.stickit();
    },
    el : '#contentdiv',
...
var partnerDetailInstance = new partnerAllDetailView();
