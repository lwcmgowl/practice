//加载并初始化模板对象
var partnerTemplate = loadTemplate("assets/templates/staff/partnerDetail.html");
var picurllist = "";
var partnerId='';
//列表容器VIEW
var marketListView = Backbone.View.extend({
    ...
    initinfo : function(id) {
        ...
        html += handlerRow(id);
        $("#back").before(html);
        // $('[href="#customerInfo"]').attr("href",'#customerInfo/'+id+'');
        ...
        if (attcId == '.jpg' || attcId == '.gif' || attcId == '.png') {
            ...
            $("#imgForm").ajaxSubmit({
                ...
                success : function(data) {
                    ...
                    $("#uppictr").append("<td id='pic" + data.msg.objectId + "'><img src='" + urldownshow + "' width='60px'  height='60px'/><a href='#delpic/" + data.msg.objectId + "/3'>删除</a> </td>");
                ...
                self.model.fetch({
                    success : function(cols, resp, options) {
                        ...
                        for (var p in piclist) {
                            ...
                            $("#uppictr").append("<td  id='pic" + piclist[p] + "'><img src='" + urldownshow + "' width='60px'  height='60px'/><a href='#delpic/" + piclist[p] + "/3'>删除</a> </td>");
...
var partnerDetailInstance = new marketListView();
