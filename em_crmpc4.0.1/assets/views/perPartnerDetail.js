        ...
        if (attcId == '.jpg' || attcId == '.gif' || attcId == '.png') {
            ...
            $("#imgForm").ajaxSubmit({
                ...
                success : function(data) {
                    ...
                    $("#uppictr").append("<td id='pic" + data.msg.objectId + "'><img src='" + urldownshow + "' width='60px'  height='60px'/><a href='#delpic/" + data.msg.objectId + "/4'>删除</a> </td>");
                ...
                self.model.fetch({
                    success : function(cols, resp, options) {
                        ...
                        for (var p in piclist) {
                            ...
                            $("#uppictr").append("<td  id='pic" + piclist[p] + "'><img src='" + urldownshow + "' width='60px'  height='60px'/><a href='#delpic/" + piclist[p] + "/4'>删除</a> </td>");
