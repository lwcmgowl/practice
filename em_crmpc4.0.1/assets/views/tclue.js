//加载并初始化模板对象
var pmarketingTemplate = loadTemplate("assets/templates/staff/teamList.html");
//列表容器VIEW
var pclueView = Backbone.View.extend({
    initialize : function() {
        this.stickit();
    },
    el : '#tclue',
    ...
    load : function() {
        ...
        new DataTable({
            ...
            pageSize : 20,
            ajax : {
                url : '/statistics/pageClueDynRegion',
                data : param,
            },
            columns : [{
                "data" : "salesUserName",
            ...
            columnDefs : [{
                ...
                render : function(i, j, c) {
                    var html = '<a type="" class="dropdown-toggle" href="javascript:;" onclick="pclueView.dynamicshow('+c.clueId+')">动态</button>'
                    return html;
                }
            }],
    ...
    exportAll:function(){
        ...
        var url = "/statistics/exportAllDynClueRegion";
